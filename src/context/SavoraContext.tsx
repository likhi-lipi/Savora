...
const initialMenuItems: MenuItem[] = [
  ...
  { id: 'menu-3', name: 'Chicken Tikka', description: 'Juicy, tender chicken pieces marinated in spiced yogurt and roasted in the tandoor.', price: 429.00, category: 'starters', image: 'https://images.unsplash.com/photo-1627308595229-7830a5c91f9f?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: [] },
  ...
  { id: 'menu-5', name: 'Seekh Kebab', description: 'Minced lamb blended with Indian spices, skewered and cooked in a clay oven.', price: 449.00, category: 'starters', image: 'https://images.unsplash.com/photo-1532636875304-0c8fe1170e3c?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: [] },
  ...
  { id: 'menu-7', name: 'Tandoori Mushroom', description: 'Fresh button mushrooms marinated in tandoori masala and grilled to a smoky finish.', price: 319.00, category: 'starters', image: 'https://images.unsplash.com/photo-1608897013039-887f21d8c804?w=600&auto=format&fit=crop&q=80', stockLevel: 'low', labels: ['Vegetarian'] },

  // Soups
  { id: 'menu-8', name: 'Tomato Dhaniya Soup', description: 'A light, comforting soup made with fresh ripe tomatoes and a hint of fresh coriander.', price: 189.00, category: 'soups', image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  ...
  { id: 'menu-13', name: 'Paneer Butter Masala', description: 'Fresh cottage cheese cubes simmered in a spiced tomato-onion gravy with dried fenugreek.', price: 389.00, category: 'mains', image: 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  ...
  { id: 'menu-15', name: 'Kadai Paneer', description: 'Cottage cheese and bell peppers cooked in a spicy, flavorful freshly ground kadai masala.', price: 379.00, category: 'mains', image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  ...
  { id: 'menu-18', name: 'Rogan Josh', description: 'A signature Kashmiri dish featuring tender mutton cooked with aromatic spices and a vibrant red chili gravy.', price: 589.00, category: 'mains', image: 'https://images.unsplash.com/photo-1603368291246-8153406e23b2?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Signature'] },
  { id: 'menu-19', name: 'Malai Kofta', description: 'Fried dumplings of potato and paneer served in a rich, mild, and creamy cashew gravy.', price: 389.00, category: 'mains', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  { id: 'menu-20', name: 'Chole Masala', description: 'Classic North Indian dish made with white chickpeas simmered in an onion-tomato masala.', price: 299.00, category: 'mains', image: 'https://images.unsplash.com/photo-1596797038530-2c107229654b?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  { id: 'menu-21', name: 'Palak Paneer', description: 'Cubes of soft paneer cooked in a smooth, mildly spiced spinach puree.', price: 369.00, category: 'mains', image: 'https://images.unsplash.com/photo-1618219908412-a29a1bb7b86e?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  ...
  { id: 'menu-24', name: 'Cheese Naan', description: 'Indulgent soft naan bread stuffed with a blend of melted cheeses.', price: 149.00, category: 'breads', image: 'https://images.unsplash.com/photo-1628294895520-280424564c7e?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  { id: 'menu-25', name: 'Tandoori Roti', description: 'Whole wheat flatbread baked in a traditional clay oven.', price: 49.00, category: 'breads', image: 'https://images.unsplash.com/photo-1505253716362-afaea1d3d1af?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  { id: 'menu-26', name: 'Butter Roti', description: 'Whole wheat tandoori roti glazed with fresh butter.', price: 59.00, category: 'breads', image: 'https://images.unsplash.com/photo-1568600891621-50f697b9a1c7?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  { id: 'menu-27', name: 'Laccha Paratha', description: 'Multi-layered, flaky whole wheat bread cooked in the tandoor.', price: 99.00, category: 'breads', image: 'https://images.unsplash.com/photo-1626132647523-66f5bf380027?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  { id: 'menu-28', name: 'Missi Roti', description: 'Savory bread made from a mix of whole wheat flour and gram flour, spiced with ajwain.', price: 89.00, category: 'breads', image: 'https://images.unsplash.com/photo-1589301760014-d929f39ce9b0?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  ...
  { id: 'menu-30', name: 'Hyderabadi Veg Biryani', description: 'Aromatic basmati rice cooked dum-style with assorted seasonal vegetables and biryani spices.', price: 359.00, category: 'rice', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  { id: 'menu-31', name: 'Mutton Dum Biryani', description: 'A royal delicacy of tender mutton pieces layered with long-grain rice and exotic spices.', price: 599.00, category: 'rice', image: 'https://images.unsplash.com/photo-1633945274405-b6c8069047b0?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Signature'] },
  { id: 'menu-32', name: 'Jeera Rice', description: 'Steamed basmati rice tempered with cumin seeds and ghee.', price: 199.00, category: 'rice', image: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  { id: 'menu-33', name: 'Steamed Basmati Rice', description: 'Perfectly cooked, long-grain aromatic white basmati rice.', price: 149.00, category: 'rice', image: 'https://images.unsplash.com/photo-1546964124-0cce460f38ef?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  { id: 'menu-34', name: 'Veg Pulao', description: 'Mildly spiced rice cooked with a colorful medley of fresh vegetables.', price: 269.00, category: 'rice', image: 'https://images.unsplash.com/photo-1633945274405-b6c8069047b0?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  ...
  { id: 'menu-37', name: 'Kulfi Falooda', description: 'Traditional Indian ice cream served with sweet vermicelli, rose syrup, and nuts.', price: 199.00, category: 'desserts', image: 'https://images.unsplash.com/photo-1517244683847-7456b63c5969?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  { id: 'menu-38', name: 'Gajar Ka Halwa', description: 'A classic winter dessert of slow-cooked grated carrots, milk, sugar, and dry fruits.', price: 219.00, category: 'desserts', image: 'https://images.unsplash.com/photo-1605270812954-355ae4586f17?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  { id: 'menu-39', name: 'Rabdi', description: 'Thickened, sweetened milk with layers of malai, flavored with saffron and cardamom.', price: 199.00, category: 'desserts', image: 'https://images.unsplash.com/photo-1587314168485-3236d6710814?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  ...
  { id: 'menu-41', name: 'Sweet Lassi', description: 'Traditional sweetened churned yogurt beverage, served cold.', price: 149.00, category: 'beverages', image: 'https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian', 'Gluten-Free'] },
  { id: 'menu-42', name: 'Masala Chai', description: 'Brewed black tea with milk and a fragrant blend of ginger, cardamom, and cloves.', price: 79.00, category: 'beverages', image: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
  ...
  { id: 'menu-45', name: 'Cold Coffee', description: 'Creamy, chilled, and frothy blended iced coffee.', price: 189.00, category: 'beverages', image: 'https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=600&auto=format&fit=crop&q=80', stockLevel: 'available', labels: ['Vegetarian'] },
...
const defaultSettings: RestaurantSettings = {
  ...
  website: 'www.savora.app',
  gstin: '29ABCDE1234F1Z5',
  email: 'support@savora.app'
};
